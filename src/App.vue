...
<template>
  <div class="min-h-screen bg-gray-800">
    <div class="container flex flex-col pt-8 mx-auto space-y-16">
      <h1 class="text-6xl font-thin tracking-tight text-center text-gray-300">
        My Todo App
      </h1>
      <input
        @change="addTodo"
        ...
        <div class="w-1/3">
          ...
          <ul class="pt-8 space-y-4">
            <li
              ...
              :key="todo.id"
              @click="changeStatus(todo.id)"
              class="w-full px-4 py-2 font-bold text-center text-green-600 duration-200 bg-gray-300 rounded-lg hover:cursor-pointer hover:bg-green-400 hover:text-gray-200"
            >
              {{ todo.content }}
            </li>
          </ul>
